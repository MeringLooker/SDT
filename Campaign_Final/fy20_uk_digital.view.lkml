view: sdt_fy20_uk_digital_campaign {
  sql_table_name: public.sdt_fy20_uk_digital_campaign ;;
...
### All measures go below ###
  ...
  measure: total_sessions {
    type: sum_distinct
    description: "Sessions for LastMinute represent Content Views"
    sql_distinct_key: ${primary_key} ;;
    sql: ${sessions} ;;
  }
  ...
  measure: avg_session_duration {
    label: "Avg. TOS"
    description: "Session Duration for LastMinute represent Time with Content."
    type: number
