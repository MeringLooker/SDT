    ...
    dimension: creative_name {
      ...
      sql:
        case
          ...
          when ${creative} ilike '%HICYB_728x90_STATIC-5%' then 'HICYB_728x90 (40% Offer)'
          ...
          when ${creative} ilike '%HICYB_300x600_STATIC-5%' then 'HICYB_300x600 (40% Offer)'
          ...
          when ${creative} ilike '%HICYB_300x250_STATIC-5%' then 'HICYB_300x250 (40% Offer)'
          ...
          when ${creative} ilike '%HICYB_160x600_STATIC-5%' then 'HICYB_160x600 (40% Offer)'
          ...
          when ${creative} ilike '%HICYB_728x90_STATIC-6%' then 'HICYB_728x90 (20% Offer)'
          when ${creative} ilike '%HICYB_970x90_STATIC-6%' then 'HICYB_970x90 (20% Offer)'
          when ${creative} ilike '%HICYB_300x250_STATIC-6%' then 'HICYB_300x250 (20% Offer)'
          when ${creative} ilike '%HICYB_160x600_STATIC-6%' then 'HICYB_160x600 (20% Offer)'
