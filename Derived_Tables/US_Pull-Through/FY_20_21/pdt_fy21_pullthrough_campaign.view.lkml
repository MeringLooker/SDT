view: pdt_fy21_pullthrough_campaign {
  derived_table: {
    sql:
          ...
          union
          select * from ${pdt_fy21_pullthrough_adara_2h_1p.SQL_TABLE_NAME}
          union
          select * from ${pdt_fy21_pullthrough_adara_2h_offline.SQL_TABLE_NAME}
          union
          select * from ${pdt_fy21_pullthrough_sojern.SQL_TABLE_NAME}
          union
          select * from ${pdt_fy21_pullthrough_tripadvisor.SQL_TABLE_NAME}
          union
          select * from ${pdt_fy21_pullthrough_ta_pub.SQL_TABLE_NAME}
          union
