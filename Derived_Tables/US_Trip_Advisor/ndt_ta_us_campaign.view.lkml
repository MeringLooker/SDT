view: ndt_ta_us_campaign {
  derived_table: {
    sql:
        select * from ${ndt_ta_us_audext_video.SQL_TABLE_NAME}
        union
        select * from ${ndt_ta_us_audext_social.SQL_TABLE_NAME}
        union
        ...
        union
        select * from ${ndt_ta_us_video_banners.SQL_TABLE_NAME}
            ;;
