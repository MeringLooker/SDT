# view: ndt_ta_can_campaign {
#   derived_table: {
#     sql:
#         select * from ${ndt_ta_can_audext_video.SQL_TABLE_NAME}
#         union
#         select * from ${ndt_ta_can_audext_social.SQL_TABLE_NAME}
#         union
#         select * from ${ndt_ta_can_homepage_hero.SQL_TABLE_NAME}
#         union
#         select * from ${ndt_ta_can_destination_sponsorship.SQL_TABLE_NAME}
#         union
#         select * from ${ndt_ta_can_hub_traffic_drivers.SQL_TABLE_NAME}
#         union
#         select * from ${ndt_ta_can_outstream_video_banners.SQL_TABLE_NAME}
#         union
#         select * from ${ndt_ta_can_video_banners.SQL_TABLE_NAME}
#             ;;
