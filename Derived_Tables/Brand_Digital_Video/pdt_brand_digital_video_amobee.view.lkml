view: pdt_brand_digital_video_amobee {
  derived_table: {
    explore_source: sdt_dcm {
      ...
      column: total_impressions {field: sdt_fy20_digital_video_amobee.total_impressions}
      column: total_views {field: sdt_fy20_digital_video_amobee.total_video_views}
      column: total_completes {field: sdt_fy20_digital_video_amobee.total_video_completes}
      column: total_cost {field: sdt_fy20_digital_video_amobee.total_media_cost}
