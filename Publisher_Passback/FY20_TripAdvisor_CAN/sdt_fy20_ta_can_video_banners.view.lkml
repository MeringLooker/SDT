view: sdt_fy20_ta_can_video_banners {
  sql_table_name: public.sdt_fy20_ta_can_video_banners ;;
  drill_fields: [id]
...
### All measures go below ###
  ...
  measure: avg_interaction_time {
    ...
    sql: (${total_interaction_time}/nullif(${total_interactions}, 0))::float/86400 ;;
    value_format: "m:ss"
  }
