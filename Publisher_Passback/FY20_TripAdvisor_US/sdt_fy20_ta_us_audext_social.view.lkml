view: sdt_fy20_ta_us_audext_social {
  sql_table_name: public.sdt_fy20_ta_us_audext_social ;;
  drill_fields: [id]
...
### Primary Key ###
  ...
  dimension: sdt_pillar {
    ...
    sql:
      case
        when ${creative_name} ilike '%Attractions%' then 'Attractions'
        when ${creative_name} ilike '%Culinary%' then 'Culinary'
        when ${creative_name} ilike '%Culture%' then 'Culture'
        when ${creative_name} ilike '%Entertainment%' then 'Entertainment'
        when ${creative_name} ilike '%Outdoors%' then 'Outdoor'
        else 'Uncategorized'
        end;;
  }
