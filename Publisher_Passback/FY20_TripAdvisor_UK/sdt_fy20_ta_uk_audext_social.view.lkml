view: sdt_fy20_ta_uk_audext_social {
  sql_table_name: public.sdt_fy20_ta_uk_audext_social ;;
  drill_fields: [id]
...
### Primary Key ###
  ...
  dimension: sdt_pillar {
    ...
    sql:
      case
        when ${creative_name} ilike 'SDTA_Attractions_%' then 'Attractions'
        when ${creative_name} ilike 'SDTA_Culinary_%' then 'Culinary'
        when ${creative_name} ilike 'SDTA_Culture_%' then 'Culture'
        when ${creative_name} ilike 'SDTA_Entertainment_%' then 'Entertainment'
        when ${creative_name} ilike 'SDTA_Outdoors_%' then 'Outdoor'
        else 'Uncategorized'
        end;;
  }
