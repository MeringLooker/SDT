  ...
  dimension: sdt_pillar {
    ...
    dimension: creative_name {
      ...
      CASE
        ...
        when ${ad_name} ilike '%OBI_USSMidway60%' then 'OBI: USS Midway (:60)'
        when ${ad_name} ilike '%OBI_USSMidway15%' then 'OBI: USS Midway (:15)'
        ...
        when ${ad_name} ilike '%OBI_LearnToSurf60%' then 'OBI: Learn to Surf (:60)'
        when ${ad_name} ilike '%OBI_LearnToSurf15%' then 'OBI: Learn to Surf (:15)'
        when ${ad_name} ilike '%OBI_WhaleWatchinng60%' then 'OBI: Whale Watching (:60)'
        when ${ad_name} ilike '%OBI_WhaleWatchinng15%' then 'OBI: Whale Watching (:15)'
        ...
        when ${ad_name} ilike '%DH_Azucar30%' then 'DH: Azucar (:30)'
        when ${ad_name} ilike '%DH_Azucar15%' then 'DH: Azucar (:15)'
